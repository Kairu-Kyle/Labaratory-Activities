...
class BankAccount {
    ...
    //Enscapsulation: Getter and Setter Methods
...
class CurrentAccount extends BankAccount{
    ...
    public void withdraw(double amount) {
        if (amount > 0 &&  (getBalance() + overDraftLimit) >= amount) {
            double noBalance = getBalance() - amount;
            if (noBalance < 0){
                overDraftLimit += noBalance; //Reduce overdraft Limit
            }
...
public class oop {
    public static void main(String[] args) {
        ...
        SavingsAccount savingsAccount = new SavingsAccount("Mark", 5000, 3);
        ...
        CurrentAccount current = new CurrentAccount("jhon",5000,1000);
